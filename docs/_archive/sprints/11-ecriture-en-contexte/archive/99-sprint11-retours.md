...
| 2026-06-28 | /6-cloture retro-sprint : sélection des 5 actions de méthode à appliquer | **LES 5 RETENUES** (tweaks faible risque, .claude/agents) : 1 early-greens IHM en cascade (tdd-analyse §4), 2 contrôle positif accès/sécurité (tdd-auto cond.5), 3 contrôle cohérence scope « Web + contrat de réponse » (tdd-analyse §2bis/§6), 4 anti-flake étendu aux TempsReel préexistants (ihm-builder ; exécution = P2), 5 design notes « → remonter au CP si ambigu » (tdd-analyse §6) | toutes dérivent de frictions réelles s11 ; aucune structurelle/produit/portes/autonomie → pas G1 |
