...
| 8 | [Ajouter un acteur sans nom est refusé](08-ajouter-sans-nom-refuse.md) | `@erreur` 🖥️ IHM · backend `tdd-auto` + runtime `ihm-builder` | ✅ GREEN backend (garde nom vide / tout-espaces : refus motif clair, aucun id, liste inchangée + caractérisation absence d'effet de bord) · ⏳ runtime `ihm-builder` (message clair à l'écran, liste inchangée) | 3/3 | ✅ GREEN (backend) · runtime ⏳ |
