...
| 5 | [Éditer un acteur hors set : nom suivi, teinte neutre conservée](05-acteur-hors-set-neutre-conservee.md) | `@limite` 🖥️ IHM · caract. `tdd-auto` + runtime `ihm-builder` | ⏳ Pending | 1/1 | 🟡 backend caract. GREEN (1/1) — runtime IHM ⏳ Pending (ihm-builder) |
