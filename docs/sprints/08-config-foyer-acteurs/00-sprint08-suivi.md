...
| 6 | [Éditer un acteur hors fenêtre : pas d'entrée fantôme](06-acteur-hors-fenetre-pas-d-entree-fantome.md) | `@limite` 🖥️ IHM · caract. `tdd-auto` + runtime `ihm-builder` | ⏳ Pending | 1/1 | 🟡 backend caract. ✅ (1/1) — runtime IHM `ihm-builder` à venir |
