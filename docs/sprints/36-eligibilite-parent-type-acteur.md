...
### Sc.4 — Éligibilité du lien basculée sur « rôle marqué parent » (REMPLACE l'option A) @back @vert
```gherkin
...
### Sc.5 — Sélecteur de la modal Enfants aligné sur « rôle marqué parent » @ihm @vert
```gherkin
