...
| 2 | [Affecter une période depuis une case colore et nomme la case](02-affecter-periode-depuis-case.md) | `@nominal 🖥️ IHM` | ⏳ Pending | 0/2 | ⏳ Pending |
...
**Avancement** : **1/7** scénarios au vert — Sc.1 livré (clic-case → dialog « Poser un slot » →
réapparition du slot, acceptation runtime sur app réellement câblée).

**Acceptation runtime IHM** : **1/7** (Sc.1 ✅).
