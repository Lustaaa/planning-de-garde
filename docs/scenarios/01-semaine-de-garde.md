...
### Scenario 5 — Chevauchement de localisation pour le même enfant `@limite` `@vert` <!-- vert — 4272015 -->
...
### Scenario 6 — Un Invité tente d'éditer un slot `@erreur` `@vert` <!-- vert — dec72b8 -->
...
### Scenario 11 — Définir le transfert de bascule entre deux parents `@nominal` `@vert` <!-- vert — db720b9 -->
