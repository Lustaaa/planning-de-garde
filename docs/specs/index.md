...
| Acteurs & configuration du foyer | [`acteurs-et-config-foyer.md`](acteurs-et-config-foyer.md) | Paliers 4/5/8 : édition, ajout, persistance Mongo, CRUD complet, gating, impersonation bornée lecture (règles 1-9). |
