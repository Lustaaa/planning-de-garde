...
| Saisie visible, grille lisible & thème | [`saisie-et-grille.md`](saisie-et-grille.md) | Paliers 2-3 : saisie visible, lisibilité (couleur + nom + légende), thème (règles 18-22) ; **rendu bicolore du transfert sur la pastille de date** — saisi (s29) **et AUTO-dérivé** (s31, présentation). |
