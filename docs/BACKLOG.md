...
*(Aucun sprint en cours.)* Dernier livré = **s34 `enfants-lien-parent`** (**3ᵉ incrément vertical
de l'épic Refonte Config foyer**) : **lien enfant↔parent** — l'enfant, jusque-là agrégat **nu**
...
> **Candidats goal prochain `/planning`** (Enfants harmonisés + lien enfant↔parent **livrés s34** ; Acteurs
> 2ᵉ incr. + Rôles/Cycle **livrés s33**) :
> (1) **4ᵉ incrément épic Refonte Config foyer — harmoniser Lieux → « Activités »** au même patron tableau
> lecture + crayon→modal, combiné au **renommage sémantique Lieux → Activités** + **lien enfant↔activité**
> (nom + adresse + liste de slots) et au **lien adresse acteur↔lieu/domicile** (retours PO gate s33) ;
...
| ~~**Harmoniser l'onglet Enfants**~~ **livré s34** : onglet Enfants au patron **tableau lecture seule + crayon → modal** (lot atomique de surface, **swap inline→modal**, comme Acteurs s32 / Rôles & Cycle s33), colonne « Parents liés » + sélecteur de parents, invariants (refus→modal ouverte, **Parent-gated**, **SignalR** lecture). **Reste : harmoniser « Lieux » → « Activités »** au même patron (retour PO gate s33) — à combiner avec le renommage Lieux→Activités (ligne dédiée ci-dessous). | 🟡 | épic Refonte Config foyer (Enfants faits, Lieux/Activités reste) | retours s29 (PO) · re-signalé gate s33 · brief config foyer |
