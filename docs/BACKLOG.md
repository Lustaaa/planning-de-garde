...
*(Aucun sprint en cours.)* Dernier livré = **s40 `completude-couple-badge`** (**7ᵉ incrément épic Refonte Config
foyer**) : **STATUT de complétude du couple R3 par enfant, en LECTURE seule** — enum `StatutCoupleR3` composé **PUR**
