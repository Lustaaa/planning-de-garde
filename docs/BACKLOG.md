...
*(Aucun sprint en cours.)* Dernier livré = **s37 `pere-mere-lien-enfant`** (**5ᵉ incrément épic Refonte
...
>
> **Candidats goal prochain `/planning`** (**rôle-du-lien père/mère résolu s37** ; Éligibilité parent
> **résolue s36** ; Activités harmonisées + renommage + lien enfant↔activité **livrés s35** ; Enfants + lien
> enfant↔parent **livrés s34** ; Acteurs 2ᵉ incr. + Rôles/Cycle **livrés s33**) :
...
> graph enfant en racine**) — **suite naturelle du lien s34/s36/s37** (le rôle-du-lien père/mère est posé,
> reste la contrainte de complétude du couple + le graphe foyer recomposé) ;
