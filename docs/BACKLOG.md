...
*(Aucun sprint en cours.)* Dernier livré = **s39 `retrofit-flake-signalr-tempsreel`** (**sprint de DETTE / INFRA
...
réelle fiable). **Candidats de tête au prochain `/planning`** (features produit) : **R3 « exactement 2 parents » /
complétude du couple**, **édition depuis le graphe**, **graphe étendu**, **arbitrage inline vs modal**, **commandes
inverses actif/admin**, **liste de slots par activité**, **lien adresse acteur↔lieu**, **suppression slot récurrent
IHM**, **suppression d'un enfant**. Précédent = **s38 `graphe-foyer-enfant-racine`** (**6ᵉ incrément épic Refonte
