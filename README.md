...
📄 Spec courante : [`docs/12-specification.md`](docs/12-specification.md)
*(les versions précédentes, ex. [`docs/11-specification.md`](docs/11-specification.md), restent figées en historique)*
