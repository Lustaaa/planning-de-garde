...
📄 Spec courante : [`docs/06-specification.md`](docs/06-specification.md)
*(les versions précédentes, ex. [`docs/05-specification.md`](docs/05-specification.md), restent figées en historique)*
