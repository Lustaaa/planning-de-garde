...
📄 Spec courante : [`docs/11-specification.md`](docs/11-specification.md)
*(les versions précédentes, ex. [`docs/10-specification.md`](docs/10-specification.md), restent figées en historique)*
