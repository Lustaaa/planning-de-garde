...
📄 Spec courante : [`docs/13-specification.md`](docs/13-specification.md)
*(les versions précédentes, ex. [`docs/12-specification.md`](docs/12-specification.md), restent figées en historique)*
