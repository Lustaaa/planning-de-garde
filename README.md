...
📄 Spec courante : [`docs/08-specification.md`](docs/08-specification.md)
*(les versions précédentes, ex. [`docs/07-specification.md`](docs/07-specification.md), restent figées en historique)*
