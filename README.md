...
📄 Spec courante : [`docs/14-specification.md`](docs/14-specification.md)
*(les versions précédentes, ex. [`docs/13-specification.md`](docs/13-specification.md), restent figées en historique)*
