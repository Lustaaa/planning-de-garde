...
namespace PlanningDeGarde.AdapterDroite.Mongo.Foyer.Repositories;

// Le segment de namespace `...Mongo.Foyer` MASQUE la classe seed `PlanningDeGarde.Application.Foyer.Seed.Foyer`
// (un global using alias ne suffit pas — il perd face au membre de namespace externe). Alias SCOPÉ ici (lot 3,
// miroir du cas InMemory lot 2) pour lire le seed (Foyer.CouleurNeutre, Foyer.TypesParActeur, Foyer.TypeParDefaut).
