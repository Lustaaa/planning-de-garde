...
/// <summary>
/// État CLIENT partagé (scoped = par circuit Blazor) du digest « immédiat » de la cloche. La grille
...
/// une reprojection de la donnée déjà chargée par le GET grille (garde-fou anti-flake). Canal de
