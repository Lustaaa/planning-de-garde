...
/// <summary>
/// Ressource <b>Session</b> (BC Comptes, connexion) — controller MVC REST. La connexion est une
...
/// La session est un état d'hôte/requête, PAS un agrégat durable (aucune persistance neuve).
/// </summary>
[ApiController]
