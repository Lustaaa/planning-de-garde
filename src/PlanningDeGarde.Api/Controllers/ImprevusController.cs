...
/// consigne une trace au journal (cloche s47) DIFFUSÉE (payload), N'ÉCRIT AUCUNE surcharge (résolution
/// jamais touchée, invariant s48). Refus métier (type inconnu) renvoyé avec son motif.
/// </summary>
[ApiController]
public sealed class ImprevusController(SignalerImprevuHandler signaler) : ControllerBase
{
    /// <summary>Signaler un imprévu (POST, s48).</summary>
