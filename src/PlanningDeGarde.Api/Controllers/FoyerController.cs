...
/// foyer « enfant-racine » : lecture AGRÉGÉE restituant, PAR enfant en racine, ses parents liés
/// (nom résolu + rôle-du-lien), reflet fidèle des liens réels. Lecture PURE — jamais de diffusion.
/// </summary>
[ApiController]
