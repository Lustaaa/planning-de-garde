...
/// handler câblé sur le store durable <see cref="ReferentielActivitesMongo"/> ; le redémarrage du serveur
...
/// </summary>
public sealed class ReferentielActivitesMongoDurabiliteTests : IDisposable
{
    ...
    public void Acceptation_Should_Relire_piscine_depuis_le_store_durable_apres_un_redemarrage_du_serveur_When_le_lieu_a_ete_ajoute_sur_le_store_Mongo_reel()
    {
        ...
        string piscineId;
        {
            ...
            var handler = new AjouterActiviteHandler(store1, store1);
        ...
        var lieux = store2.EnumererActivites();
